...
sudo cp ./ports_change/ports.conf /etc/apache2/
sudo cp ./ports_change/000-default.conf /etc/apache2/sites-enabled/
sudo cp ptt_device_discovery.py /var/www/
sudo rm /var/www/html/timelogger/pages/header.html
sudo cp ./ports_change/header.html /var/www/html/timelogger/pages/
sudo systemctl restart apache2
sudo systemctl restart ptt_discovery.service
sudo echo -e "\e[33mSoftware running port changed back to default port:80\e[0m"
sleep 5
